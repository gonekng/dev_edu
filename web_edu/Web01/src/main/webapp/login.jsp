...
%>
	<!-- form 안의 데이터들이 submit 되면 name의 이름을 가지고 back단으로 이동함 -->
		...
		<form action="loginAction.jsp" method="POST">
			...
			<div class="form-floating">
				<input type="password" class="form-control" id="userPW"
					name="userPW" placeholder="Password"> <label for="userPW">Password</label>
			</div>
			<div class="form-floating" style="visibility:hidden;">
				<input type="password" class="form-control" id="userName"
					name="userName" placeholder="Name"> <label for="userName">Name</label>
			</div>
